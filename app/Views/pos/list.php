                    ...
                    <?php foreach($transactions as $row): ?>
                        <tr>
                            ...
                            <td class="px-2 py-1 align-middle text-center">
                                <a href="<?= base_url('pembayaran/transaction_view/'.$row['id']) ?>" class="mx-2 text-decoration-none text-dark"><i class="fa fa-eye"></i></a>
                                <a href="<?= base_url('pembayaran/transaction_delete/'.$row['id']) ?>" class="mx-2 text-decoration-none text-danger" onclick="if(confirm('Are you sure to delete <?= $row['code'] ?> from list?') !== true) event.preventDefault()"><i class="fa fa-trash"></i></a>
                            </td>
                        </tr>
                    <?php endforeach; ?>
