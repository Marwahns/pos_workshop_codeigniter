...
<div class="content-wrapper">
    ...
    <a class="btn btn-success" href="<?= base_url('stok/createStokKeluar') ?>" style="margin-bottom: 10px; margin-left: 15px;"><i class="fa fa-plus mr-2"></i> Add Stock Out</a>
