                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="btn-group btn-group-sm">
                                                        <a href="<?= base_url('stok/view_detailStokMasuk/' . $row->id) ?>" class="btn btn-default bg-gradient-light border text-dark rounded-0" title="View Spare Parts"><i class="fa fa-eye"></i></a>
                                                        
                                                        <a href="<?= base_url('stok/deleteStokMasuk/' . $row->id) ?>" class="btn btn-danger rounded-0" title="Delete Spare Parts"><i class="fa fa-trash"></i></a>
                                                    </div>
                                                </td>
                                            </tr>
                                        <?php endforeach; ?>
